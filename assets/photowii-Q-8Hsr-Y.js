import{j as a}from"./vendor-BOJxWFg6.js";import{b as ea,e as E}from"./index-_14aYUL1.js";import{initCargaSistema as U,Historial as sa,cargarImagen as na,canvasToBlob as O,estimarTamano as la,formatBytes as oa,descargarBlob as pa}from"./adevs-nJjaW-ZD.js";let d={width:800,height:600,bg:"white",quality:80},B=!1,p=null,_=null,v=[],o=null,W=0;const F=new sa(7);let M=null;const D=[{id:"webp",label:"WebP",ext:"webp",enabled:!0},{id:"jpeg",label:"JPEG",ext:"jpg",enabled:!0},{id:"png",label:"PNG",ext:"png",enabled:!1},{id:"avif",label:"AVIF",ext:"avif",enabled:!1}],N={brightness:100,contrast:100,saturate:100,shadows:0,blur:0,hueRotate:0};let j=null,Y=!1;async function ra(){return new Promise(t=>{const i=new Image;i.onload=()=>t(!0),i.onerror=()=>t(!1),i.src="data:image/avif;base64,"})}const xa=()=>`
...
`,Ba=async()=>{if(console.log(`✅ PhotoWii de ${ea} cargado`),await ra()){const t=D.find(i=>i.id==="avif");t&&(t.supported=!0)}else{const t=D.findIndex(i=>i.id==="avif");t!==-1&&D.splice(t,1)}aa(),a("#pwBtnCrear").on("click",da),a("#pwBtnLimpiar").on("click",ba),a("#pwDocW, #pwDocH").on("input",function(){B&&(d.width=parseInt(a("#pwDocW").val())||800,d.height=parseInt(a("#pwDocH").val())||600,Z(d.width,d.height))}),a('input[name="pw_bg"]').on("change",function(){B&&(d.bg=a(this).val(),u(),b())}),a("#pwBtnAdd").on("click",()=>a("#pwFileInput").trigger("click")),a("#pwFileInput").on("change",t=>{t.target.files.length&&H(Array.from(t.target.files)),t.target.value=""}),M=U({dropSel:"#pwDropzone",fileSel:"#pwFileInput",clickSel:null,onFile:t=>H([t]),namespace:"pw"}),a("#pwQuality").on("input",function(){const t=a(this).val();a("#pwQualityTxt").val(t),d.quality=parseInt(t),R()}),a("#pwQualityTxt").on("input",function(){let t=Math.min(100,Math.max(10,parseInt(a(this).val())||80));a(this).val(t),a("#pwQuality").val(t),d.quality=t,R()}),a("#pwTogglesRow").on("click",".pw_toggle_btn",function(){fa(a(this).data("fmt"))}),a("#pwBtnExport").on("click",va),a("#pwFormatsRow").on("click",".pw_fmt_btn_dl",function(){_a(a(this).data("fmt"),this)}),a("#pwCapaX, #pwCapaY, #pwCapaW, #pwCapaH").on("change",ca),a("#pwCapaOp").on("input",function(){a("#pwCapaOpTxt").val(a(this).val()+"%"),o&&(o.opacity=parseInt(a(this).val())/100,u())}).on("change",()=>b()),["brightness","contrast","saturate","shadows"].forEach(t=>{a(`#f_${t}`).on("input",function(){o&&(o.filtros[t]=parseInt(a(this).val()),a(`#val_${t}`).text(o.filtros[t]),u())}).on("change",()=>b())}),a("#pwResetFiltros").on("click",()=>{o&&(o.filtros={...N},T(o.id),u(),b())}),a("#pwBtnUndo").on("click",ga),a("#pwBtnRedo").on("click",ma),a("#pwBtnRotL").on("click",()=>G(-90)),a("#pwBtnRotR").on("click",()=>G(90)),a("#pwBtnFlipH").on("click",()=>{o&&(o.flipH*=-1,u(),b())}),a("#pwBtnFlipV").on("click",()=>{o&&(o.flipV*=-1,u(),b())}),ha(),wa()};function da(){const t=parseInt(a("#pwDocW").val())||800,i=parseInt(a("#pwDocH").val())||600,e=a('input[name="pw_bg"]:checked').val();if(t<10||i<10||t>8e3||i>8e3)return E("Dimensiones inválidas","error");d.width=t,d.height=i,d.bg=e,p=document.getElementById("pwDocCanvas"),_=p.getContext("2d",{willReadFrequently:!0}),p.width=t,p.height=i,B=!0,v=[],o=null,F.reset(),a("#pwPlaceholder").hide(),a("#pwStageScroll, #pwToolbar, #pwFormatsRow").fadeIn(300),a("#pwCardCapas, #pwCardExport").css({opacity:1,pointerEvents:"all"}),a("#pwBtnLimpiar").prop("disabled",!1),X(),u(),b(),R()}function Z(t,i){p.width=t,p.height=i,X(),u(),b()}function X(){a("#pwDocDimBadge").text(`${p.width} × ${p.height}`),a("#pwDocW").val(p.width),a("#pwDocH").val(p.height)}async function H(t){if(!B)return E("Primero crea el documento","warning");for(let i of t)try{const e=await na(i);W++;const s={id:`layer_${W}`,img:e.img,file:i,name:e.name,w:e.width,h:e.height,x:0,y:0,opacity:1,visible:!0,rotate:0,flipH:1,flipV:1,filtros:{...N}},n=Math.min(d.width/s.w,d.height/s.h,1);n<1&&(s.w=Math.round(s.w*n),s.h=Math.round(s.h*n)),s.x=Math.round((d.width-s.w)/2),s.y=Math.round((d.height-s.h)/2),v.push(s),K(s),T(s.id)}catch(e){console.error("Error capa:",e)}k(),u(),b(),R()}function K(t){const i=`
  ...
  `;a("#pwLayersDiv").append(i),L(t)}function L(t){const i=a(`#dom_${t.id}`);if(i.length){if(!t.visible){i.hide();return}i.show().css({left:t.x+"px",top:t.y+"px",width:t.w+"px",height:t.h+"px",zIndex:v.indexOf(t)})}}function k(){const t=a("#pwLayerList").empty();for(let i=v.length-1;i>=0;i--){const e=v[i],s=o&&o.id===e.id,n=e.visible?"fa-eye":"fa-eye-slash hidden";t.append(`
    ...
    `)}}a("#pwLayerList").on("click",".pw_layer_item",function(t){const i=a(this).data("id");if(a(t.target).hasClass("pw_layer_eye")){const e=v.find(s=>s.id===i);e&&(e.visible=!e.visible,L(e),u(),k());return}if(a(t.target).hasClass("pw_layer_del")){v=v.filter(e=>e.id!==i),a(`#dom_${i}`).remove(),o&&o.id===i&&T(null),u(),k(),b(),R();return}T(i)});function T(t){if(o=v.find(i=>i.id===t)||null,a(".pw_layer_dom").removeClass("pw_active"),a("#pwCardColor, #pwCardCapaActiva").hide(),o){a(`#dom_${t}`).addClass("pw_active"),a("#pwCardCapaActiva, #pwCardColor").fadeIn(200),a("#pwCapaX").val(o.x),a("#pwCapaY").val(o.y),a("#pwCapaW").val(o.w),a("#pwCapaH").val(o.h),a("#pwCapaOp").val(o.opacity*100),a("#pwCapaOpTxt").val(Math.round(o.opacity*100)+"%");const i=o.filtros;a("#f_brightness").val(i.brightness),a("#val_brightness").text(i.brightness),a("#f_contrast").val(i.contrast),a("#val_contrast").text(i.contrast),a("#f_saturate").val(i.saturate),a("#val_saturate").text(i.saturate),a("#f_shadows").val(i.shadows),a("#val_shadows").text(i.shadows)}k()}function ca(){o&&(o.x=parseInt(a("#pwCapaX").val())||0,o.y=parseInt(a("#pwCapaY").val())||0,o.w=parseInt(a("#pwCapaW").val())||10,o.h=parseInt(a("#pwCapaH").val())||10,L(o),u(),b())}function G(t){o&&(o.rotate=(o.rotate+t)%360,u(),b())}function wa(){let t=!1,i=!1,e,s,n,r,l,c=null;function C(){return p?p.width/p.getBoundingClientRect().width:1}a("#pwLayersDiv").on("mousedown touchstart",".pw_layer_dom",function(h){if(Y)return;const x=a(this).data("id");if(l=v.find(w=>w.id===x),!l)return;T(x),a(h.target).hasClass("pw_layer_handle")?(i=!0,r=a(h.target).data("h")):t=!0;const A=h.touches?h.touches[0]:h;e=A.clientX,s=A.clientY,n={x:l.x,y:l.y,w:l.w,h:l.h},h.preventDefault(),h.stopPropagation()}),a(window).on("mousemove.pw touchmove.pw",function(h){if(!t&&!i||!l)return;const x=h.touches?h.touches[0]:h,A=C(),w=(x.clientX-e)*A,f=(x.clientY-s)*A;if(t)l.x=Math.round(n.x+w),l.y=Math.round(n.y+f);else if(i){let g=n.w,m=n.h,S=n.x,z=n.y;const P=n.w/n.h;if(r.includes("e")&&(g=Math.max(10,n.w+w)),r.includes("s")&&(m=Math.max(10,n.h+f)),r.includes("w")){const I=Math.min(w,n.w-10);g=n.w-I,S=n.x+I}if(r.includes("n")){const I=Math.min(f,n.h-10);m=n.h-I,z=n.y+I}if(r.length===2){const I=Math.abs(g-n.w),ia=Math.abs(m-n.h);I>ia?m=g/P:g=m*P,m=Math.max(10,m),g=Math.max(10,g),r.includes("w")&&(S=n.x+(n.w-g)),r.includes("n")&&(z=n.y+(n.h-m))}l.w=Math.round(g),l.h=Math.round(m),l.x=Math.round(S),l.y=Math.round(z)}L(l),a("#pwCapaX").val(l.x),a("#pwCapaY").val(l.y),a("#pwCapaW").val(l.w),a("#pwCapaH").val(l.h),c&&cancelAnimationFrame(c),c=requestAnimationFrame(()=>u())}).on("mouseup.pw touchend.pw",function(){(t||i)&&(c&&(cancelAnimationFrame(c),c=null),u(),b(),R()),t=!1,i=!1,l=null})}function u(){!B||!_||(_.clearRect(0,0,p.width,p.height),d.bg==="white"&&(_.fillStyle="#ffffff",_.fillRect(0,0,p.width,p.height)),v.forEach(t=>{if(!t.visible)return;_.save(),_.globalAlpha=t.opacity,_.translate(t.x+t.w/2,t.y+t.h/2),_.rotate(t.rotate*Math.PI/180),_.scale(t.flipH,t.flipV);const i=t.filtros;_.filter=`brightness(${i.brightness}%) contrast(${i.contrast}%) saturate(${i.saturate}%) blur(${i.blur}px) hue-rotate(${i.hueRotate}deg)`;const e=t.rotate%180!==0?t.h:t.w,s=t.rotate%180!==0?t.w:t.h;_.drawImage(t.img,-e/2,-s/2,e,s),_.restore(),i.shadows}),v.forEach(L))}let y=null,$=0;function ha(){y=a("#pwCropArea"),a("#pwBtnCrop").on("click",()=>{B&&(Y=!0,a("#pwCropOverlay, #pwCropBar").fadeIn(200),a("#pwToolbar").hide(),a(".pw_layer_dom").css("pointer-events","none"),Q())}),a(".pw_ratio_btn").on("click",function(){a(".pw_ratio_btn").removeClass("active"),a(this).addClass("active"),$=parseFloat(a(this).data("r")),Q()}),a("#pwCropCancel").on("click",V),a("#pwCropApply").on("click",()=>{const l=p.getBoundingClientRect(),c=y[0].getBoundingClientRect(),C=p.width/l.width,h=Math.round((c.left-l.left)*C),x=Math.round((c.top-l.top)*C),A=Math.round(c.width*C),w=Math.round(c.height*C);_.getImageData(h,x,A,w),d.width=A,d.height=w,Z(A,w),v.forEach(f=>{f.x-=h,f.y-=x}),u(),b(),V()});let t=!1,i=!1,e,s,n,r;y.on("mousedown touchstart",l=>{a(l.target).hasClass("pw_crop_handle")?(i=!0,r=a(l.target).data("h")):t=!0;const c=l.touches?l.touches[0]:l;e=c.clientX,s=c.clientY,n={left:y[0].offsetLeft,top:y[0].offsetTop,width:y.width(),height:y.height()},l.preventDefault()}),a(window).on("mousemove touchmove",l=>{if(!t&&!i)return;const c=l.touches?l.touches[0]:l,C=c.clientX-e,h=c.clientY-s,x=a("#pwCropOverlay").width(),A=a("#pwCropOverlay").height();if(t){let w=n.left+C,f=n.top+h;w=Math.max(0,Math.min(w,x-n.width)),f=Math.max(0,Math.min(f,A-n.height)),y.css({left:w,top:f})}else if(i){let w=n.width,f=n.height,g=n.left,m=n.top;r.includes("e")&&(w+=C),r.includes("s")&&(f+=h),r.includes("w")&&(w-=C,g+=C),r.includes("n")&&(f-=h,m+=h),$>0&&(r.includes("e")||r.includes("w")?f=w/$:w=f*$),w>50&&f>50&&g>=0&&m>=0&&g+w<=x&&m+f<=A&&y.css({width:w,height:f,left:g,top:m})}J()}).on("mouseup touchend",()=>{t=!1,i=!1})}function Q(){const t=a("#pwCropOverlay").width(),i=a("#pwCropOverlay").height();let e=t*.8,s=i*.8;$>0&&(t/i>$?e=s*$:s=e/$),y.css({width:e,height:s,left:(t-e)/2,top:(i-s)/2}),J()}function J(){const t=p.getBoundingClientRect(),i=p.width/t.width,e=Math.round(y.width()*i),s=Math.round(y.height()*i);a("#pwCropDims").text(`${e} × ${s}`)}function V(){Y=!1,a("#pwCropOverlay, #pwCropBar").hide(),a("#pwToolbar").fadeIn(200),a(".pw_layer_dom").css("pointer-events","all")}function aa(){let t="";D.forEach(i=>{if(i.id==="avif"&&!i.supported)return;const e=i.enabled?"pw_toggle_on":"pw_toggle_off",s=i.enabled?"fa-check-circle":"fa-circle";t+=`<div class="pw_toggle_btn ${e}" data-fmt="${i.id}"><i class="fas ${s}"></i> ${i.label}</div>`}),a("#pwTogglesRow").html(t),ua()}function fa(t){const i=D.find(e=>e.id===t);i&&(i.enabled=!i.enabled,aa(),R())}function ua(){const t=a("#pwFormatsRow"),i=D.filter(s=>s.enabled);if(i.length===0){t.html('<div style="text-align:center; padding:2vh;">Selecciona formato a exportar.</div>');return}let e="";i.forEach(s=>{e+=`
    ...
    `}),t.html(e)}function R(){clearTimeout(j),!(!B||!p)&&(a("#pwFormatsRow .pw_fmt_size").html('<i class="fas fa-spinner fa-spin"></i>'),a("#pwFormatsRow .pw_fmt_btn_dl").prop("disabled",!0),j=setTimeout(async()=>{const t=D.filter(e=>e.enabled);let i=0;try{i=(await O(p,"image/png")).size}catch{}t.forEach(e=>{const s=e.id==="png"?void 0:d.quality/100;la(p,`image/${e.id}`,s,n=>{if(!n){a(`#pwSize_${e.id}`).text("Error");return}a(`#pwSize_${e.id}`).text(oa(n,!0)),a(`#pwCard_${e.id} .pw_fmt_btn_dl`).prop("disabled",!1);const r=a(`#pwSav_${e.id}`);if(i>0&&e.id!=="png"){const l=i-n,c=Math.round(l/i*100);c>0?r.html(`<i class="fas fa-arrow-down"></i> -${c}%`).removeClass("pw_savings_up").addClass("pw_savings_dn").show():c<0?r.html(`<i class="fas fa-arrow-up"></i> +${Math.abs(c)}%`).removeClass("pw_savings_dn").addClass("pw_savings_up").show():r.hide()}else r.hide()})})},500))}async function va(){if(!B)return;const t=D.filter(e=>e.enabled);if(!t.length)return E("Selecciona al menos un formato","warning");const i=a("#pwBtnExport");i.prop("disabled",!0).html('<i class="fas fa-spinner fa-spin"></i> Exportando...'),u();for(let e of t)try{a(`#pwBar_${e.id}`).css("width","10%").removeClass("pw_bar_done");const s=e.id==="png"?void 0:d.quality/100,n=await O(p,`image/${e.id}`,s);a(`#pwBar_${e.id}`).css("width","100%").addClass("pw_bar_done"),a(`#pwCard_${e.id}`).addClass("pw_fmt_done")}catch{a(`#pwBar_${e.id}`).css({width:"100%",background:"var(--error)"})}i.prop("disabled",!1).html('<i class="fas fa-rocket"></i> Exportación Completa'),setTimeout(()=>i.html('<i class="fas fa-rocket"></i> Iniciar Exportación'),2e3),E("¡Listos para descargar!","success")}async function _a(t,i){const e=D.find(r=>r.id===t);if(!e)return;const s=a(i),n=s.html();s.prop("disabled",!0).html('<i class="fas fa-spinner fa-spin"></i>');try{const r=e.id==="png"?void 0:d.quality/100,l=await O(p,`image/${e.id}`,r),c=`PhotoWii_Doc.${e.ext}`;pa(l,c),E(`¡${e.label} descargado!`,"success")}catch{E("Error al exportar","error")}finally{s.prop("disabled",!1).html(n)}}function b(t){if(!B)return;const i={w:d.width,h:d.height,bg:d.bg,capas:v.map(e=>({...e,filtros:{...e.filtros}}))};F.guardar(i),q()}function ga(){const t=F.undo();t&&ta(t),q()}function ma(){const t=F.redo();t&&ta(t),q()}function ta(t){d.width=t.w,d.height=t.h,d.bg=t.bg,p.width=t.w,p.height=t.h,X(),a('input[name="pw_bg"][value="'+t.bg+'"]').prop("checked",!0),v=t.capas.map(i=>({...i,filtros:{...i.filtros}})),a("#pwLayersDiv").empty(),v.forEach(K),o?T(o.id):k(),u(),R()}function q(){a("#pwBtnUndo").prop("disabled",!F.canUndo()),a("#pwBtnRedo").prop("disabled",!F.canRedo())}function ba(){M&&M(),B=!1,p=null,_=null,v=[],o=null,W=0,F.reset(),a("#pwLayersDiv").empty(),a("#pwStageScroll, #pwToolbar, #pwFormatsRow").hide(),a("#pwPlaceholder").show(),a("#pwCardCapas, #pwCardExport").css({opacity:.5,pointerEvents:"none"}),a("#pwCardCapaActiva, #pwCardColor").hide(),a("#pwBtnLimpiar").prop("disabled",!0),a("#pwFileInput").val(""),E("Documento cerrado","info"),M=U({dropSel:"#pwDropzone",fileSel:"#pwFileInput",clickSel:null,onFile:t=>H([t]),namespace:"pw"})}const Da=()=>{M&&M(),a("#pwBtnCrear, #pwBtnLimpiar, #pwBtnAdd, #pwBtnCrop, #pwCropCancel, #pwCropApply, #pwBtnExport").off(),a("#pwTogglesRow, #pwFormatsRow, #pwLayerList, #pwLayersDiv").off(),a('input[type="range"], input[type="number"], input[type="radio"]').off(),a(window).off("mousemove touchmove mouseup touchend")};export{Da as cleanup,Ba as init,xa as render};
