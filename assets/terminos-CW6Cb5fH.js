/* empty css              */import{j as i}from"./vendor-BOJxWFg6.js";import{b as s,v as o,x as l,y as r}from"./index-DfI58Hqs.js";const t=[{ico:"fa-user-shield",color:"#0EBEFF",num:"01",tit:"Uso de la Plataforma",body:`<p>${s} es una herramienta digital de edición y optimización de imágenes. Al usar nuestra aplicación, te comprometes a:</p>
    <ul class="tm_list">
    ...
    </ul>`},{ico:"fa-lock",color:"#FF5C69",num:"02",tit:"Propiedad Intelectual",body:`<p>Todo el software, diseño y algoritmos de <strong>${s}</strong> son propiedad exclusiva de sus creadores. Sin embargo:</p>
    <ul class="tm_list">
    ...
    </ul>`},{ico:"fa-circle-exclamation",color:"#FFDA34",num:"03",tit:"Limitación de Responsabilidad",body:`<p>Trabajamos para ofrecer la mejor calidad, pero debes tener en cuenta que:</p>
    <ul class="tm_list">
    ...
    </ul>`},{ico:"fa-file-contract",color:"#29C72E",num:"04",tit:"Modificaciones",body:"<p>Nos reservamos el derecho de actualizar estos términos para adaptarnos a nuevas funciones o leyes. Te avisaremos de cambios importantes a través de la plataforma.</p>"}],n=[{q:"¿Es realmente gratis?",a:"Sí, la versión gratuita te permite optimizar y editar imágenes con límites generosos y sin letras pequeñas."},{q:"¿Qué pasa con mis datos?",a:"Procesamos todo localmente siempre que es posible o en servidores temporales cifrados que borran todo tras el proceso."},{q:"¿Uso comercial?",a:"Absolutamente. Todas las imágenes que proceses con nuestras herramientas pueden ser utilizadas en proyectos comerciales sin restricciones."},{q:"¿Necesito cuenta?",a:"Para las funciones básicas no es necesario, pero una cuenta te permite guardar preferencias y acceder a herramientas Pro."}],u=()=>`
<main id="wimain">
<div class="ac_wrap tm_wrap">
  ...
  <section class="ac_hero tm_hero">
    ...
    <div class="ac_hero_body">
      ...
      <p class="ac_hero_sub">
        Queremos que uses <strong>${s}</strong> con total confianza. 
        Aquí te explicamos las reglas claras para nuestra comunidad.
      </p>
      <div class="tm_hero_chips">
        <span class="tm_chip"><i class="fas fa-clock"></i> Actualizado: ${r()}</span>
        <span class="tm_chip"><i class="fas fa-code-branch"></i> Versión: ${o}</span>
        ...
        <div class="tm_sec_card wi_fadeUp">
          <div class="tm_sec_header">
            ...
            <div class="tm_sec_head_txt">
              <span class="tm_sec_num">${a.num}</span>
    ...
    <div class="tm_cta_premium wi_fadeUp">
      ...
      <div class="tm_cta_inner">
        ...
        <div class="tm_cta_btns">
          ...
          <a href="${l}" class="ac_btn_s ac_btn_lg"><i class="fas fa-house"></i> Volver al Inicio</a>
        </div>
      </div>
    </div>
  </section>
...
`,_=()=>{const a=new IntersectionObserver(c=>{c.forEach(e=>{e.isIntersecting&&i(e.target).addClass("visible")})},{threshold:.1});i(".wi_fadeUp").each(function(){a.observe(this)}),console.log(`⚖️ ${s} Términos cargados con diseño Premium`)},f=()=>{console.log("🧹 Términos limpiado")};export{f as cleanup,_ as init,u as render};
