import{j as t}from"./vendor-gzd0YkcT.js";import{c as M,N as d,w as O}from"./main-BWRqHA95.js";import"./main-BgQ3oyBL.js";import"./firebase-xYuwcABI.js";let s=[],c=null,b=!1,z=1;const A=i=>{if(!i)return"0 B";const e=1024,a=["B","KB","MB","GB"],o=Math.floor(Math.log(i)/Math.log(e));return`${(i/Math.pow(e,o)).toFixed(1)} ${a[o]}`},W=()=>`
