import{j as e}from"./vendor-BOJxWFg6.js";import{auth as d}from"./firebase-Dmdwa-GF.js";import{o as u}from"./firebase-D-ROeyul.js";import{b as c,g as f,r as p,a as v,S as _}from"./index-_14aYUL1.js";const h=()=>new Promise(s=>{if(d.currentUser)return s(d.currentUser);const o=u(d,t=>{o(),s(t)})}),r=s=>{try{const o=JSON.parse(localStorage.getItem(s));return Array.isArray(o)?o:o?.value&&Array.isArray(o.value)?o.value:[]}catch{return[]}},F=()=>`
  <div class="gs_dash">
