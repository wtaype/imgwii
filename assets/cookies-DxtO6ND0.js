/* empty css              */import{j as e}from"./vendor-BOJxWFg6.js";import{b as i,x as o,y as r}from"./index-BawKnUft.js";const t=[{ico:"fa-shield-halved",color:"#0EBEFF",tit:"Cookies Técnicas",desc:"Esenciales para que la plataforma funcione. Permiten la navegación, el uso de herramientas de edición y el cambio de temas visuales.",necesaria:!0},{ico:"fa-chart-pie",color:"#FF5C69",tit:"Análisis y Rendimiento",desc:"Nos ayudan a entender cómo usas nuestras herramientas de imagen (cuáles son las más populares) para mejorar la velocidad y eficiencia.",necesaria:!1},{ico:"fa-user-gear",color:"#29C72E",tit:"Personalización",desc:"Recuerdan tus preferencias, como el último filtro usado o la configuración de compresión favorita, para que no tengas que reconfigurarlas.",necesaria:!1}],_=()=>`
<main id="wimain">
