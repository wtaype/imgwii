import{j as i,i as b}from"./vendor-BOJxWFg6.js";import{b as _,e as r,n as w}from"./index-D-jC5gH6.js";let n=null,t=null;const g=a=>{if(!a)return"0 B";const e=1024,o=["B","KB","MB","GB"],s=Math.floor(Math.log(a)/Math.log(e));return`${(a/Math.pow(e,s)).toFixed(1)} ${o[s]}`},P=()=>`
