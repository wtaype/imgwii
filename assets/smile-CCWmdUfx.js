import{j as a}from"./vendor-BOJxWFg6.js";import{auth as d}from"./firebase-CIMG1A84.js";import{o as v}from"./firebase-D-ROeyul.js";import{g as _,r as p,a as f,S as h,b as u}from"./index-B7g3A6lw.js";const g=()=>new Promise(e=>{if(d.currentUser)return e(d.currentUser);const s=v(d,r=>{s(),e(r)})}),c=e=>{try{const s=JSON.parse(localStorage.getItem(e));return Array.isArray(s)?s:s?.value&&Array.isArray(s.value)?s.value:[]}catch{return[]}},$=()=>`
  <div class="smw_dash">
