import{j as e,C as b}from"./vendor-BOJxWFg6.js";import{b as w,e as r,n as _}from"./index-DfI58Hqs.js";let s=null,t=null;const v=i=>{if(!i)return"0 B";const a=1024,n=["B","KB","MB","GB"],o=Math.floor(Math.log(i)/Math.log(a));return`${(i/Math.pow(a,o)).toFixed(1)} ${n[o]}`},P=()=>`
