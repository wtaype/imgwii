import{j as e}from"./vendor-gzd0YkcT.js";import{i as I}from"./browser-image-compression-DILJcqf6.js";import{c as z,N as l,w as F}from"./main-WnjZvDdb.js";import"./main-BXvQAZNN.js";import"./firebase-xYuwcABI.js";let n=null,t=null,w=!1;const x=a=>{if(!a)return"0 B";const i=1024,s=["B","KB","MB","GB"],o=Math.floor(Math.log(a)/Math.log(i));return`${(a/Math.pow(i,o)).toFixed(1)} ${s[o]}`},j=()=>`
