import{j as i}from"./vendor-gzd0YkcT.js";import{i as b}from"./browser-image-compression-DILJcqf6.js";import{c as _,N as r,w}from"./main-Bn2LpapF.js";import"./main-CvMjg8zc.js";import"./firebase-xYuwcABI.js";let n=null,t=null;const g=a=>{if(!a)return"0 B";const e=1024,o=["B","KB","MB","GB"],s=Math.floor(Math.log(a)/Math.log(e));return`${(a/Math.pow(e,s)).toFixed(1)} ${o[s]}`},C=()=>`
