import{j as e}from"./vendor-BOJxWFg6.js";import{b as m,e as o,n as b}from"./index-zaTe2JFH.js";let n=null,_=1,l={brightness:100,contrast:100,saturate:100,blur:0,grayscale:0,sepia:0,hueRotate:0,invert:0,opacity:100,rotate:0,flipH:1,flipV:1};const w=t=>{if(!t)return"0 B";const a=1024,i=["B","KB","MB","GB"],s=Math.floor(Math.log(t)/Math.log(a));return`${(t/Math.pow(a,s)).toFixed(1)} ${i[s]}`},I=()=>`
...
`,A=()=>{console.log(`✅ Editor de ${m} cargado`);const t=e("#dropZone");e("#fileInput").on("change",a=>p(a.target.files[0])),e("#btnResetFilters").on("click",g),e("#btnApplyFilters").on("click",V),e("#btnDownloadCurrent").on("click",$),e("#btnFlipH").on("click",()=>v("h")),e("#btnFlipV").on("click",()=>v("v")),t.on("dragover",a=>{a.preventDefault(),t.addClass("dragover")}),t.on("dragleave",a=>{a.preventDefault(),t.removeClass("dragover")}),t.on("drop",a=>{a.preventDefault(),t.removeClass("dragover");const i=a.originalEvent.dataTransfer.files;i.length&&p(i[0])}),t.on("dblclick",a=>{a.preventDefault(),e("#fileInput").trigger("click")}),e(document).on("paste",x),y(),C()},x=t=>{const a=t.originalEvent?.clipboardData?.items;if(!a)return;let i=!1;e.each(a,(s,r)=>{if(r.type.startsWith("image/")){const d=r.getAsFile();if(!d)return!0;const h=new File([d],`Captura_${_++}.png`,{type:d.type});return p(h),i=!0,e("#dropZone, #previewArea").addClass("paste_flash"),setTimeout(()=>{e("#dropZone, #previewArea").removeClass("paste_flash")},300),!1}}),!i&&t.originalEvent?.clipboardData?.items?.length>0&&o("No se detectó imagen en portapapeles","error",2e3)};function p(t){if(!t)return;if(!t.type.startsWith("image/"))return o(`${t.name}: no es una imagen`,"error",2e3);if(t.size>50*1024*1024)return o(`${t.name}: muy grande (máx 50MB)`,"error",2e3);const a=new FileReader;a.onload=i=>{const s=new Image;s.onload=()=>{n={file:t,original:{url:i.target.result,size:t.size,width:s.width,height:s.height,name:t.name},img:s},f(),g(),o("Imagen cargada","success",1500),u()},s.src=i.target.result},a.readAsDataURL(t)}function f(){if(!n)return;e("#dropZone").is(":visible")&&e("#dropZone").fadeOut(200,()=>e("#previewArea").removeClass("dpn").hide().fadeIn(300));const t=e("#editCanvas")[0];t.getContext("2d");const a=n.img;t.width=a.width,t.height=a.height,c(),e("#previewStats").removeClass("dpn").hide().fadeIn(200),e("#statNombre").text(n.original.name),e("#statDimensiones").text(`${n.original.width}×${n.original.height}`),e("#statTamano").text(w(n.original.size))}function y(){["brightness","contrast","saturate","blur","grayscale","sepia","hueRotate","invert","opacity","rotate"].forEach(a=>{e(`#${a}`).on("input",function(){const i=e(this).val();l[a]=parseFloat(i);let s=i;a==="blur"?s=`${i}px`:a==="rotate"||a==="hueRotate"?s=`${i}°`:s=`${i}%`,e(`#${a}Value`).text(s),c()})})}function c(){if(!n)return;const t=e("#editCanvas")[0],a=t.getContext("2d"),i=n.img;a.clearRect(0,0,t.width,t.height),a.save(),a.translate(t.width/2,t.height/2),a.rotate(l.rotate*Math.PI/180),a.scale(l.flipH,l.flipV),a.filter=`
    ...
    invert(${l.invert}%)
    opacity(${l.opacity}%)
  `,a.drawImage(i,-i.width/2,-i.height/2,i.width,i.height),a.restore()}function g(){l={brightness:100,contrast:100,saturate:100,blur:0,grayscale:0,sepia:0,hueRotate:0,invert:0,opacity:100,rotate:0,flipH:1,flipV:1},e("#brightness").val(100),e("#brightnessValue").text("100%"),e("#contrast").val(100),e("#contrastValue").text("100%"),e("#saturate").val(100),e("#saturateValue").text("100%"),e("#blur").val(0),e("#blurValue").text("0px"),e("#grayscale").val(0),e("#grayscaleValue").text("0%"),e("#sepia").val(0),e("#sepiaValue").text("0%"),e("#hueRotate").val(0),e("#hueRotateValue").text("0°"),e("#invert").val(0),e("#invertValue").text("0%"),e("#opacity").val(100),e("#opacityValue").text("100%"),e("#rotate").val(0),e("#rotateValue").text("0°"),c(),o("Filtros reseteados","info",1500)}function v(t){t==="h"?l.flipH*=-1:l.flipV*=-1,c()}function V(){if(!n)return;e("#editCanvas")[0].toBlob(a=>{const i=new File([a],n.original.name,{type:"image/png"});n.file=i,n.original.size=a.size,o("¡Filtros aplicados!","success",2e3),u()},"image/png")}function $(){if(!n)return;e("#editCanvas")[0].toBlob(a=>{const i=URL.createObjectURL(a),s=document.createElement("a");s.href=i,s.download=n.original.name.replace(/\.[^.]+$/,"_editado.png"),document.body.appendChild(s),s.click(),document.body.removeChild(s),URL.revokeObjectURL(i),b("#btnDownloadCurrent","¡Descargado! 🎉","success",1500)},"image/png")}const u=()=>{if(!n)return;const t={name:n.original.name,url:n.original.url,size:n.original.size,width:n.original.width,height:n.original.height,filtros:l};localStorage.setItem("editar_session",JSON.stringify(t))},C=()=>{const t=localStorage.getItem("editar_session");if(!(!t||n))try{const a=JSON.parse(t),i=new Image;i.onload=()=>{n={file:null,original:{url:a.url,name:a.name,size:a.size,width:a.width,height:a.height},img:i},l=a.filtros||l,f(),Object.keys(l).forEach(s=>{if(e(`#${s}`).length){e(`#${s}`).val(l[s]);let r=l[s];s==="blur"?r=`${l[s]}px`:s==="rotate"||s==="hueRotate"?r=`${l[s]}°`:r=`${l[s]}%`,e(`#${s}Value`).text(r)}}),console.log("✅ Imagen restaurada")},i.src=a.url}catch(a){console.error("Error cargando sesión:",a)}},D=()=>{u(),e(document).off("paste")};export{D as cleanup,A as init,I as render};
