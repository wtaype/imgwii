import{j as e}from"./vendor-BOJxWFg6.js";import{auth as d}from"./firebase-DOAmJy7U.js";import{o as u}from"./firebase-D-ROeyul.js";import{b as c,g as f,r as p,a as v,S as _}from"./index-zaTe2JFH.js";const h=()=>new Promise(s=>{if(d.currentUser)return s(d.currentUser);const o=u(d,t=>{o(),s(t)})}),r=s=>{try{const o=JSON.parse(localStorage.getItem(s));return Array.isArray(o)?o:o?.value&&Array.isArray(o.value)?o.value:[]}catch{return[]}},F=()=>`
  <div class="gs_dash">
