import{j as i}from"./vendor-BOJxWFg6.js";import{auth as y,db as u}from"./firebase-DOAmJy7U.js";import{i as I,c as h,h as A,e as b,q as L,w as T,g as S,f}from"./firebase-D-ROeyul.js";import{e as n,m as l,g as U,n as p}from"./index-zaTe2JFH.js";const e="wiAudios",g="wiImg",m=()=>U("wiSmile")?.email||y.currentUser?.email||"",d=async s=>{const t=m();if(!t)return[];const r=L(h(u,s),T("email","==",t));return(await S(r)).docs.map(c=>({id:c.id,...c.data()})).sort((c,o)=>(o.creado?.seconds||0)-(c.creado?.seconds||0))},v=async(s,t,r)=>{const a=m();return a?(await I(h(u,s),{email:a,titulo:t,src:r,creado:f(),actualizado:f()})).id:null},x=async(s,t)=>{await A(b(u,s,t))},B=()=>d(e),D=()=>d(g),C=(s,t)=>`
