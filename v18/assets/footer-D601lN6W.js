import{j as a}from"./vendor-BOJxWFg6.js";import{b as e,v as c,l,j as n,k as r,w as d,g as v,i as f,s as m}from"./index-zaTe2JFH.js";const k=[{tit:"YouTube",ico:"fab fa-youtube",url:"https://www.youtube.com/@wiihope",bg:"#ff0000"},{tit:"Facebook",ico:"fab fa-facebook-f",url:"https://www.facebook.com/wiihopee",bg:"#1877F2"},{tit:"Instagram",ico:"fab fa-instagram",url:"https://www.instagram.com/WiiHopee",bg:"linear-gradient(45deg,#f58529,#dd2a7b,#515bd4)"},{tit:"TikTok",ico:"fab fa-tiktok",url:"https://www.tiktok.com/@wiihope",bg:"#000"}];function p(){const s=new Date;return`
  <footer class="foo">
    <div class="foo_inner">
      <div class="foo_left">
        <div class="foo_brand">
  ...
  `}a("body").append(p());a("head").append('<style>:root{--bgim:url("/imgwii/v18/wpuntos.svg")}body{background: var(--bgim), var(--bg)}</style>');a("body").append(`
