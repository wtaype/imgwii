import{j as s}from"./vendor-gzd0YkcT.js";import{c as i}from"./main-VEFui3rb.js";import"./main-Hd9TPuUq.js";import"./firebase-xYuwcABI.js";const n=()=>`
...
`,d=()=>{console.log(`✅ Acerca de ${i} cargado`),s(".mission_card, .objective_card, .tech_card, .feature_item").each(function(a){s(this).css({"animation-delay":`${a*.05}s`})})},l=()=>{console.log("🧹 Acerca limpiado")};export{l as cleanup,d as init,n as render};
